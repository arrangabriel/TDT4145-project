...
cursor.execute('''INSERT INTO Roast VALUES ("Jacobsen & Svart", "light roast", '2022-01-20 00:00:00', "Vinterkaffe 2022", "A tasty and complex coffee for polar nights", 600, 1)''')
con.commit()
con.close()